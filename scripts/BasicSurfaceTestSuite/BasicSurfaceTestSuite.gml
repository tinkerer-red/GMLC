...
function BasicSurfaceTestSuite() : TestSuite() constructor {
	...
	addFact("surface_resize", function() {
		...
		// Resize the surface and then check its width and height match what it was resized to
	...
	{
		// Doesnt work on HTML5 or console
	...
	addFact("surface_depth_disable #1", function() {
		...
		// enable automatic depth buffer generation and then check if its been enabled
	...
	addFact("surface_depth_disable #2", function() {
		...
		// disable automatic depth buffer generation and then check if its been disabled
	...
	addFact("surface_create_ext", function() {
		...
		// (testing of this function could be imrpoved by checking if its been attached to the canvas element)
