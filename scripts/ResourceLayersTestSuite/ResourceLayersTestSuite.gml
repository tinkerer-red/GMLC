function ResourceLayersTestSuite() : TestSuite() constructor {
	...
	addFact("layer_background_test", function() {
		...
		// Early exit (we dont have a layer background to work with)
		if (!output) return;
	...
	addFact("layer_tile_test_legacy", function() {
		...
		// Early exit (we dont have a layer tile to work with)
		if (!output) return;
	...
	addFact("layer_sprite_test", function() {
		...
		// Early exit (we dont have a layer sprite to work with)
		if (!output) return;
	...
	addFact("layer_tilemap_test", function() {
		...
		// Early exit (we dont have a layer tilemap to work with)
		if (!output) return;
	...
	addFact("layer_sequence_test", function() {
		...
		// Early exit (we dont have a layer sequence to work with)
		if (!output) return;
