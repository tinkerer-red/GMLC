...
function BasicMathTestSuite() : TestSuite() constructor {
	...
	addFact("angle_difference_test", function() {
		...
		//do_trace("start angle_difference() test");
	...
	addFact("dot_product_3d_normalised_test", function() {
		...
		//do_trace("Begin dot_product_3d_normalised test")
		...
		//do_trace("End dot_product_3d_normalised test")
		')
	})
	...
	addFact("dot_product_3d_test", function() {
		...
		// dot_product_3d test
		//do_trace("Begin dot_product_3d test")
		...
		////do_trace(string(resNeg))
		assert_less(resNeg, 0, "#6")
			
		//do_trace("End dot_product_3d test")
		')
	})
	...
	addFact("dot_product_normalised_test", function() {
		...
		//do_trace("Begin dot_product_normalised test")
		...
		//do_trace("End dot_product_normalised test")
		')
	})
	...
	addFact("dot_product_test", function() {
		...
		// dot_product test
		//do_trace("Begin dot_product test")
	...
	addFact("lengthdir_x_test", function() {
		...
		//do_trace("Begin lengthdir_x test")
		...
		while (dAngle <= 360.0)
		{
			...
			//do_trace("_xPos: " + string(_xPos) + " | lengthDirX: " + string(lengthDirX))
			assert_equals(_xPos, lengthDirX, "Unit Circle Test At Angle " + string(dAngle))
			
			dAngle += 0.5
		}
			
		//do_trace("End lengthdir_x test")
		')
	})
	...
	addFact("lengthdir_y_test", function() {
		...
		//do_trace("Begin lengthdir_y test")
		...
		while (dAngle <= 360.0)
		{
			...
			//do_trace("_yPos: " + string(_yPos) + " | lengthDirY: " + string(lengthDirY))
			assert_equals(_yPos, lengthDirY, "Unit Circle Test At Angle " + string(dAngle))
			
			dAngle += 0.5
		}
			
		//do_trace("End lengthdir_y test")
		')
	})
	...
	addFact("math_get_epsilon_test", function() {
		...
		//do_trace("start math_get_epsilon() test");
		...
		// tests that returned epsilon value from math_get_epsilon doesnt change if internal epsilon value isnt changed
		...
		//do_trace("end math_get_epsilon() test");
		')
	})
	...
	addFact("math_set_epsilon_test", function() {
		...
		//do_trace("start math_set_epsilon() test");
	...
	addFact("point_distance_3d_test", function() {
		...
		//do_trace("start point_distance_3d() test");
	...
	addFact("tan_test", function() {
		...
		//do_trace("kPiDivFour_TanTest: " + string(kPiDivFour_TanTest))
