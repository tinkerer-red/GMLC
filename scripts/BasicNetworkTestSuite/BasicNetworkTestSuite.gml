		...
		ev_web_networking: function() {
			...
			switch (_asyncLoad[? "type"]) {
				...
				case network_type_data:
					...
					assert_equals(output, dataLength, "#2 network_send_packet(), failed sent/received data size doesnt match");
					
					output = buffer_read(buf, buffer_f64);
					assert_equals(output, data, "#3 network_send_packet(), failed sent/received values dont match");
