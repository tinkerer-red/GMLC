...
function ResourceAudioBuffersTestSuite() : TestSuite() constructor {
	...
	addTestAsync("Queueing sounds test #1", objTestAsyncAudioPlayback, {
		...
		ev_async_audio_playback: function() {
			...
			assert_equals(queueShutdown, 0, "Queue shutdown should be 0 when audio isnt stopped by freeing the queue"); // Known issue https://github.com/YoYoGames/GameMaker-Bugs/issues/7390
