...
function BasicVariableTestSuite() : TestSuite() constructor {
	...
	addFact("parameter_count_tests", function() {
		...
		if (os_browser == browser_not_a_browser) {
			...
			switch (os_type) 
			{
				...
				{
					do_trace("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
					do_trace("parameter_count_test needs to be updated to support this platform: " + string(os_type));
					do_trace("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
					break;
				}
			}
	...
	addFact("parameter_string_tests", function() {
		...
		//do_trace("Begin parameter_string_test");
			...
			switch (os_type) 
			{
				case os_windows:
				{
					if (!code_is_compiled()) 
					{
						...
						//do_trace("Param count: " + string(paramCount));
						if (paramCount >= 0)
						{
							var paramIndex;
							for (paramIndex = 0; paramIndex < paramCount; ++paramIndex)
							{
								...
								//do_trace("Param: " + string(paramIndex + 1) + ": " + paramStr);
				...
				{
					do_trace("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
					do_trace("parameter_string_test needs to be updated to support this platform: " + string(os_type));
					do_trace("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
					break;
				}
			}
		...
		//do_trace("End parameter_string_test");
		')
	})
