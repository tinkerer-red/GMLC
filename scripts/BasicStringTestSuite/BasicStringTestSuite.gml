...
function BasicStringTestSuite() : TestSuite() constructor {
	...
	// STRING_COUNT TESTS
	{
		addFact("string_count_test #1", function() {
			...
			assert_equals(numLs, 3, "string_count( string const , string local ), Hello World should have 3 ls");
			assert_equals(numOs, 2, "string_count( string const , string local ), Hello World should have 2 os");
		...
		addFact("string_count_test #4", function() {
			...
			assert_equals(numNines, 5, "string_count( string const , string local ), £999.99 should have 5 9s");
		...
		addFact("string_count_test #6", function() {
			...
			assert_equals(numFives, 5, "string_count( string const , string local ), €12555.55 should have 5 5s");
		...
		addFact("string_count_test #7", function() {
			...
			assert_equals(numAi, 4, "string_count( string const , string local ), 合気道合気道合気道合気道 should have 4 合s");
	...
	// STRING_LAST_POS_EXT TESTS
	{
		...
		addFact("string_last_pos_ext_test #4", function() {
			...
			// Check that a substring is not found when it doesnt exist in the string
		...
		addFact("string_last_pos_ext_test #6", function() {
			...
			// Check that a substring cant be found when starting at the first char
		...
		addFact("string_last_pos_ext_test #7", function() {
			...
			// Check that a substring cant be found when starting at a negative value
		...
		addFact("string_last_pos_ext_test #8", function() {
			...
			// Check that a substring cannot be found when letter cases dont match
	...
	// STRING_LAST_POS TESTS
	{
		...
		addFact("string_last_pos_test #2", function() {
			...
			// Check that a substring that isnt in the input string isnt found
	...
	// STRING_REPLACE_ALL TESTS
	{
		...
		addFact("string_replace_all_test #9", function() {
			...
			// Check that replacing a substring that doesnt exist within the string does nothing
