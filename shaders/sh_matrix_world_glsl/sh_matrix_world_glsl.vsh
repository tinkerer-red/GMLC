...
// It will test gm_Matrices[MATRIX_WORLD] by setting the red component of each rectangle in the grid to each expected value in the matrix,
...
void main()
{
	...
	float actual_value = gm_Matrices[MATRIX_WORLD][row][column];
