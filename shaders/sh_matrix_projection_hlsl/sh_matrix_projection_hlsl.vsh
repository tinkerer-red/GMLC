...
// It will test gm_Matrices[MATRIX_PROJECTION] by setting the red component of each rectangle in the grid to each expected value in the matrix,
...
VertexShaderOutput main(VertexShaderInput INPUT) {
	...
	float actual_value = gm_Matrices[MATRIX_PROJECTION][column][row];
