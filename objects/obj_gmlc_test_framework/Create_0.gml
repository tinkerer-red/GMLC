...
gmlc.exposeMacros({
	...
	//suite macros
	"suite_start_hook": "startHook",
	"suite_end_hook": "endHook",
	"suite_timeout_millis": "timeoutMillis",
...
gmlc.exposeEnums({
	"RainbowColors": {
		...
		"Orange": RainbowColors.Orange,
		"Yellow": RainbowColors.Yellow,
		"Green": RainbowColors.Green,
		"Blue": RainbowColors.Blue,
		"Indigo": RainbowColors.Indigo,
		"Violet": RainbowColors.Violet,
	}
});
