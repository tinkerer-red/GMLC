...
/////////////////////////////////////////// GAME INTRO ///////////////////////////////////////////////////
        case state.intro:
            ...
            if yy >= y_max
                {
                // Draw extra text
                draw_text_colour(xx, rm.height - 30, "(C) Nocturne Games", cc, cc, cc, cc, 1);
                draw_text(xx, rm.height - 80, "HIGH SCORE TO BEAT: " + string(map.ID[? "player_high_score"]));
                draw_text(xx, rm.height - 180, "CONTROLS");
                draw_text(xx, rm.height - 160, "Keyboard: Arrow Keys, Space");
                draw_text(xx, rm.height - 140, "Gamepad0: Left Stick, A");
                if time <= 0
                    {
                ...
                for (var i = 0; i < 3; i++;)
                    ...
                    if map.ID[? "game_menu_pos"] == i
                         ...
                         switch (i)
                             ...
                             case 0: // PLAY THE GAME!
                                draw_text_transformed_colour(xx, ry - 34 + (i * 30) - 3 + random(6), "PLAY", 1.5, 1.9 + random(0.2), -10 + random(20), cc, cc, cc, cc, 1);
                             ...
                             case 1: // Change Accent Colour
                                draw_text_transformed_colour(xx, ry - 34 + (i * 30) - 3 + random(6), "COLOUR", 1.5, 1.9 + random(0.2), -10 + random(20), cc, cc, cc, cc, 1);
                                ...
                                break;
                             case 2: // Quit Game
                                draw_text_transformed_colour(xx, ry - 34 + (i * 30) - 3 + random(6), "QUIT", 1.5, 1.9 + random(0.2), -10 + random(20), cc, cc, cc, cc, 1);
                                if keyboard_check(vk_space) || gamepad_button_check(0, gp_face1)
                                    {
                                    game_end();
                                    }
                    ...
                    switch (i)
                        {
                        case 0: draw_text_transformed(xx, ry - 30 + (i * 30), "PLAY", 1.5, 1.5, 0); break;
                        case 1: draw_text_transformed(xx, ry - 30 + (i * 30), "COLOUR", 1.5, 1.5, 0); break;
                        case 2: draw_text_transformed(xx, ry - 30 + (i * 30), "QUIT", 1.5, 1.5, 0); break;
                        }
                    }
                }
...
//////////////////////////////////// GAME INTRO FADE / LEVEL FADE ////////////////////////////////////////////
        case state.intro_fade:
            ...
            // Draw level text
            draw_text_transformed_colour(rm.width / 2, rm.height - 100, "LEVEL " + string(map.ID[? "game_level"]), 3, 2.9 + random(0.2), -10 + random(20), c, c, c, c, 1);
            draw_text_transformed(rm.width / 2, rm.height - 100, "LEVEL " + string(map.ID[? "game_level"]), 3, 3, 0);
            break;
...
//////////////////////////////////////// GAME OVER ///////////////////////////////////////////////
        case state.gameover:
            ...
            if map.ID[? "game_draw_alpha"] >= 1
                {
                draw_text(xx, yy + 64, "YOUR SCORE: " + string(map.ID[? "player_score"]));
                if map.ID[? "game_high_score"] == true
                    {
                    draw_text_colour(xx, yy + 80, "NEW HIGH SCORE", choose(c_white, cc), choose(c_white, cc), choose(c_white, cc), choose(c_white, cc), 1);
                    }
                draw_text(xx, rm.height - 32, "Press any key");
