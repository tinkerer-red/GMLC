...
function Surgeon() {
	...
	*/
	...
	if (!ds_exists(0,ds_type_map)) {
	  ...
	  __view_set( e__VW.WView, 0, GAME.view_width );
	  __view_set( e__VW.HView, 0, GAME.view_height );
	  __view_set( e__VW.WPort, 0, GAME.view_width );
	  __view_set( e__VW.HPort, 0, GAME.view_height );
	...
	draw_text_transformed(8,8,string_hash_to_newline("Score: "+string(floor(GENERAL[?"score"]))),2,2,0);
	...
	//*** PAUSED STEP/DRAW:
	  ...
	  draw_text_transformed_colour(GAME.view_width/2,32,string_hash_to_newline("NOT TETRIS"),6,4,0,c_teal,c_teal,c_purple,c_purple,1);
	  draw_set_colour(c_maroon);
	  draw_text_transformed(GAME.view_width/2,96,string_hash_to_newline("One Script Game by Surgeon_"),2,2,0);
	  ...
	  draw_text_ext_transformed_colour(32,160,string_hash_to_newline(s),20,800,1.15,1,-3,c_green,c_blue,c_yellow,c_red,1);  
