            ...
            //INFINITE RUNNER
                ...
                if grid[# (player[? "bulletx"] div World.CELL_SIZE)+1,
                            ...
                            if player_init{
                                    ...
                                    draw_text(200 , 690, "LEVEL "+string(player[? "level"]));
                                    draw_text_transformed_colour(60, 690, "Lives " +string(player[? "lives"]), 1, 1, 0, Colors.WHITE, Colors.WHITE, Colors.WHITE, Colors.WHITE, 1);
                            }
