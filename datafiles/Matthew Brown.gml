#define osg
///The Whole Game Is Just In This Script. Somehow.
...
if end_game != true {
    draw_text_ext(100, 50, event[current_event], -1, 800);
} else {
    if time >= 52 {
        draw_text_ext(100, 50, "You actually did it, I'm amazed. Connection with the mainland has been re-established, so everything's all nice and perfect and stuff now. But now they'll be in charge, so I guess you'll have to look for a new job. Oh well, I'm sure you'll be well compensated for your good work. Congrats. Have a virtual cookie.", -1, 800);
        current_event = 1000
        choices[1000, 0] = "Yay";
        choices[1000, 1] = "Yay";
        choices[1000, 2] = "Yay";
    ...
    if public <= 0 {
        draw_text_ext(100, 50, "The people have gotten so displeased with your rule that they're revolting! The whole city is in anarchy!", -1, 800);
        current_event = 1000
        choices[1000, 0] = "Aw";
        choices[1000, 1] = "Aw";
        choices[1000, 2] = "Aw";
    ...
    if alien <= 0 {
        draw_text_ext(100, 50, "The Ventori have grown tired of you. So tired in fact, that they obliterated your entire city. Might want to stay on their good side next time.", -1, 800);
        current_event = 1000
        choices[1000, 0] = "Aw";
        choices[1000, 1] = "Aw";
        choices[1000, 2] = "Aw";
    ...
    if army <= 0 {
        draw_text_ext(100, 50, "Your army was weak and the Terth noticed. And then they conquered your city. So now you get to be bossed around by slow, stupid aliens. Good work.", -1, 800);
        current_event = 1000
        choices[1000, 0] = "Aw";
        choices[1000, 1] = "Aw";
        choices[1000, 2] = "Aw";
    ...
    if money <= 0 {
        draw_text_ext(100, 50, "You ran out of money, and shortly thereafter you ran out of evertything else. The whole city ended up getting bought out by various parties. So now you have nothing.", -1, 800);
        current_event = 1000
        choices[1000, 0] = "Aw";
        choices[1000, 1] = "Aw";
        choices[1000, 2] = "Aw";
...
var width;
width = min(125, string_width(choices[current_event, 0]));
draw_text_ext(650-width, 300, choices[current_event, 0], -1, 250);
width = min(125, string_width(choices[current_event, 1]));
draw_text_ext(450-width, 450, choices[current_event, 1], -1, 250);
width = min(125, string_width(choices[current_event, 2]));
draw_text_ext(850-width, 450, choices[current_event, 2], -1, 250);
width = min(125, string_width(choices[current_event, 3]));
draw_text_ext(650-width, 600, choices[current_event, 3], -1, 250);

draw_text(930, 50, "Week: " + string(time));

// Draw the status bars

draw_text(40, 270, "Public Opinion");
draw_healthbar(40, 300, 190, 315, public, c_white, c_red, c_blue, 0, true, true);
draw_text(40, 350, "Alien Opinion");
draw_healthbar(40, 380, 190, 395, alien, c_white, c_red, c_blue, 0, true, true);
draw_text(40, 430, "Army Strength");
draw_healthbar(40, 460, 190, 475, army, c_white, c_red, c_blue, 0, true, true);
draw_text(40, 510, "Availible Funds");
draw_healthbar(40, 540, 190, 555, money, c_white, c_red, c_blue, 0, true, true);
draw_text(40, 590, "City Energy Level");
